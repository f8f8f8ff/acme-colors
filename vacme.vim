...
" This is a modified version of https://github.com/olivertaylor/vacme/
...
exe "hi! CursorColumn"     ." guifg=".s:W4    ." ctermfg=".s:WC4 ." guibg=".s:G1    ." ctermbg=".s:GC1
exe "hi! CursorLine"     ." guifg=".s:W4    ." ctermfg=".s:WC4 ." guibg=".s:G1    ." ctermbg=".s:GC1
